...
__all__ = [
    'SP_VISEME_6', 'SLTUser', 'SAFT8kHz8BitMono',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVEPhoneme',
    'SP_VISEME_4', 'SAFTGSM610_22kHzMono', 'DISPID_SGRsDynamic',
    'SpeechInterference', 'DISPID_SGRsAdd', 'DISPID_SVPriority',
    'DISPID_SPPsCount', 'SVEVoiceChange', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechMemoryStream', 'SAFTDefault', 'SPEI_RESERVED1',
    'SINoSignal', 'SP_VISEME_17', 'SPAUDIOBUFFERINFO',
    'DISPID_SGRSRule', 'SITooSlow', 'SDTRule', 'SVSFIsFilename',
    'SPEI_SR_RETAINEDAUDIO', 'ISpRecoGrammar', 'SAFT44kHz8BitStereo',
    'DISPIDSPTSI', 'eLEXTYPE_RESERVED7', 'DISPID_SVGetAudioInputs',
    'DISPID_SRAudioInput', 'DISPID_SRDisplayUI',
    'DISPID_SRCRequestedUIType', 'DISPID_SRIsUISupported',
    'SpLexicon', 'SAFT12kHz8BitStereo', 'ISpShortcut',
    'SpeechTokenKeyUI', 'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SAFType',
    'SPPS_SuppressWord', 'DISPID_SPEAudioSizeTime', 'SECFIgnoreWidth',
    'DISPID_SAFGetWaveFormatEx', 'SAFT11kHz8BitMono',
    'STCInprocHandler', 'DISPID_SWFEExtraData', 'DISPID_SpeechVoice',
    'DISPID_SMSADeviceId', 'DISPID_SPEDisplayAttributes',
    'SREHypothesis', 'SPVPRI_ALERT', 'SpNotifyTranslator',
    'SVEAllEvents', 'SWTDeleted', 'DISPID_SOTRemove',
    'ISpeechFileStream', 'SRTExtendableParse',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechObjectTokens',
    'SPWT_PRONUNCIATION', 'eLEXTYPE_RESERVED9',
    'DISPID_SRRRecoContext', 'DISPID_SRCEventInterests',
    'SVF_Emphasis', 'SPWORDPRONUNCIATIONLIST',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SAEventHandle',
    'DISPID_SLPType', 'SGDisplay', 'DISPID_SDKGetlongValue',
    'SVSFParseSapi', 'DISPID_SOTIsUISupported',
    'SpStreamFormatConverter', 'SVEPhoneme', 'ISpMMSysAudio',
    'SAFTADPCM_44kHzStereo', 'SPDKL_CurrentConfig', 'SPEVENT',
    'SPEI_FALSE_RECOGNITION', 'SGDSInactive', 'DISPID_SGRsFindRule',
    'DISPID_SOTsCount', 'SP_VISEME_10', 'SPBOOKMARKOPTIONS',
    'DISPID_SOTGetAttribute', 'SpeechCategoryAppLexicons',
    'SPEI_PHONEME', 'DISPID_SPILanguageId', 'SPGS_ENABLED',
    'SpeechAudioProperties', '_ISpeechVoiceEvents',
    'SpeechGrammarRuleStateTransitionType', 'SVPNormal',
    'SAFTADPCM_8kHzMono', 'ISpeechPhraseElement', 'SVSFDefault',
    'DISPID_SPIElements', 'eLEXTYPE_PRIVATE7',
    'SpeechAudioFormatGUIDWave', 'SpeechRecognizerState',
    'SPEVENTSOURCEINFO', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SGRAddState', 'ISpPhoneticAlphabetConverter',
    'SRAORetainAudio', 'DISPID_SRCResume', 'SPFM_NUM_MODES',
    'SRESoundEnd', 'SVP_9', 'DISPID_SLWsItem',
    'DISPID_SRCRetainedAudioFormat', 'SP_VISEME_8',
    'DISPID_SRSCurrentStreamPosition', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechPhraseBuilder', 'SREFalseRecognition',
    'DISPID_SVSRunningState', 'SREPropertyStringChange',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechLexiconPronunciation',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRCEHypothesis',
    'SPINTERFERENCE_NONE', 'SECFEmulateResult', 'SPWF_SRENGINE',
    'DISPID_SpeechRecognizerStatus', 'SVF_None',
    'SAFT24kHz16BitStereo', 'SPBO_PAUSE', 'SpeechVoiceSpeakFlags',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_RESERVED8', 'ISpRecoCategory',
    'ISpeechPhraseProperties', 'SECNormalConfidence', 'SP_VISEME_0',
    'DISPID_SLPs_NewEnum', 'DISPID_SOTGetDescription',
    'SPPS_Noncontent', 'SVSFParseMask', 'ISpeechRecoResult2',
    'SPSHT_NotOverriden', 'SPPS_Verb', 'SPEI_PHRASE_START',
    'SPEI_END_INPUT_STREAM', 'DISPID_SMSGetData', 'ISpVoice',
    'DISPID_SVEStreamStart', 'SECFDefault', 'DISPID_SRSClsidEngine',
    'SpeechGrammarWordType', 'SPADAPTATIONRELEVANCE',
    'DISPID_SWFEAvgBytesPerSec', 'DISPIDSPTSI_ActiveLength', 'SPWORD',
    'SGRSTTWildcard', 'DISPID_SVPause', 'SAFT22kHz8BitMono',
    'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE17', 'SP_VISEME_2',
    'SPAUDIOOPTIONS', 'ISpeechLexiconWords', 'DISPID_SRCEStartStream',
    'SPVOICESTATUS', 'DISPID_SpeechObjectToken', 'eLEXTYPE_PRIVATE3',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechRecoResult',
    'ISpeechVoiceStatus', 'DISPID_SVSLastStreamNumberQueued', 'SVP_1',
    'SpeechRecoEvents', 'DISPID_SpeechRecoContextEvents',
    'SpPhoneticAlphabetConverter', 'SRTSMLTimeout',
    'SpeechFormatType', 'DISPID_SRGReset', 'DISPID_SGRSTNextState',
    'DISPID_SASCurrentDevicePosition', 'SPSMF_SAPI_PROPERTIES',
    'SVP_19', 'SAFT44kHz16BitStereo', 'SAFT8kHz8BitStereo',
    'SPDATAKEYLOCATION', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechAudioStatus', 'SPPS_Interjection', 'SRAExport',
    'DISPID_SpeechAudioBufferInfo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechWordPronounceable', 'DISPID_SVSpeakCompleteEvent',
    'SPBO_TIME_UNITS', 'SAFTCCITT_ALaw_8kHzMono', 'STCRemoteServer',
    'SDTAudio', 'STSF_CommonAppData', 'SGSExclusive',
    'ISpeechGrammarRuleStateTransition', 'SVP_0',
    'SVSFParseAutodetect', 'tagSTATSTG', 'ISpProperties',
    'DISPID_SVDisplayUI', 'DISPID_SDKSetBinaryValue',
    'DISPID_SBSRead', 'ISpeechVoice', 'SVSFNLPSpeakPunc', 'SPAO_NONE',
    'SPCS_ENABLED', 'SDTAll', 'DISPID_SOTId', 'SPPS_LMA',
    'SAFT11kHz16BitStereo', 'DISPID_SRGDictationSetState',
    'SPRECOSTATE', 'SREAdaptation', 'SpeechTokenValueCLSID',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPRsItem',
    'DISPID_SPIEngineId', 'SAFT24kHz8BitMono', 'SVP_2',
    'SRERecognition', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSTPropertyValue', 'SREStreamEnd', 'SAFT24kHz16BitMono',
    '__MIDL_IWinTypes_0009', 'SpeechDisplayAttributes',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRGCommit',
    'DISPID_SpeechLexiconWords', 'SPFM_OPEN_READWRITE',
    '_ISpeechRecoContextEvents', 'DISPID_SLWWord', 'ISpRecoGrammar2',
    'SpFileStream', 'SAFTCCITT_ALaw_8kHzStereo', 'SSFMOpenForRead',
    'SPSVerb', 'SpeechPartOfSpeech', 'DISPID_SRGCmdLoadFromFile',
    'SSTTTextBuffer', 'SPPARTOFSPEECH', 'DISPID_SRGetPropertyString',
    'SpeechEngineConfidence', 'DISPID_SOTs_NewEnum',
    'SPEI_REQUEST_UI', 'SPEI_PROPERTY_NUM_CHANGE',
    'SWPUnknownWordPronounceable', 'SpeechGrammarTagWildcard',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPPChildren',
    'SPVPRI_NORMAL', 'DISPID_SPEPronunciation', 'DISPID_SRGId',
    'SpeechSpecialTransitionType', 'SAFTText', 'DISPID_SRRTTickCount',
    'SPEI_SOUND_START', 'SP_VISEME_3', 'DISPID_SLWLangId', 'ISpAudio',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPIDSPRG',
    'SPSHORTCUTTYPE', 'SGSDisabled',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechMMSysAudio', 'DISPID_SWFEFormatTag',
    'DISPID_SRRSaveToMemory', 'eLEXTYPE_RESERVED4', 'SPPS_RESERVED3',
    'SGRSTTDictation', 'ISpPhrase', 'DISPID_SPIGrammarId',
    'DISPID_SPEAudioTimeOffset', 'SpeechRuleAttributes',
    'DISPID_SAStatus', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRAudioInputStream', 'SVEEndInputStream',
    'ISpeechPhoneConverter', 'DISPID_SLGetWords', 'SSTTWildcard',
    'SP_VISEME_16', 'SECFNoSpecialChars', 'DISPID_SpeechDataKey',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRRTStreamTime',
    'DISPID_SRCEFalseRecognition', 'STCInprocServer', 'SPSFunction',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPAsCount', 'DISPID_SGRs_NewEnum',
    'DISPID_SPIReplacements', 'DISPID_SLPsCount', 'SPAS_RUN',
    'DISPID_SGRSTType', 'SPRS_ACTIVE', 'DISPID_SDKOpenKey', 'SVP_15',
    'SDTPronunciation', 'DISPID_SFSClose', 'SGLexical', 'SPSMF_UPS',
    'DISPID_SABIMinNotification', 'DISPID_SLPLangId', 'SPWT_DISPLAY',
    'ISpeechDataKey', 'SpeechDataKeyLocation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVRate',
    'SITooFast', 'SP_VISEME_18',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SBOPause',
    'DISPID_SDKGetBinaryValue', 'SpCustomStream',
    'SpeechTokenIdUserLexicon', 'DISPID_SRCEAdaptation',
    'SAFT44kHz8BitMono', 'DISPID_SBSWrite', 'DISPID_SOTDisplayUI',
    'DISPID_SPRulesCount', 'DISPID_SRRDiscardResultInfo',
    'ISpeechPhraseInfo', 'SPSTREAMFORMATTYPE',
    'DISPID_SVSLastBookmarkId', 'SAFT11kHz16BitMono',
    'DISPID_SpeechMemoryStream', 'SPSModifier', 'SPBO_NONE',
    'ISpNotifySink', 'ISpeechGrammarRule', 'ISpeechResourceLoader',
    'DISPID_SVStatus', 'ISpStreamFormatConverter', 'DISPID_SRGRules',
    'DISPID_SpeechLexicon', 'SpInProcRecoContext',
    'SAFT8kHz16BitMono', 'DISPID_SPRulesItem',
    'DISPID_SLGetPronunciations', 'SRSEIsSpeaking',
    'SpUnCompressedLexicon', 'DISPID_SVVoice', 'eLEXTYPE_USER',
    'Speech_StreamPos_RealTime', 'DISPID_SPAsItem', 'DISPID_SRRAudio',
    'DISPID_SPEDisplayText', 'DISPID_SPRNumberOfElements',
    'DISPID_SPRs_NewEnum', 'SPSNoun', 'DISPID_SpeechVoiceStatus',
    'ISpeechGrammarRules', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SOTSetId', 'SRSInactive', 'SREInterference',
    'SpeechTokenContext', 'tagSPTEXTSELECTIONINFO', 'ISpPhraseAlt',
    'SRERequestUI', 'SASPause', 'DISPID_SADefaultFormat',
    'SpMemoryStream', 'DISPID_SPIAudioStreamPosition',
    'SPSHT_Unknown', 'DISPID_SPIProperties', 'SPEI_MAX_SR',
    'Speech_Max_Word_Length', 'SPLO_STATIC',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SLGetGenerationChange', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_PRIVATE12', 'SPSHT_OTHER', 'DISPID_SRCEBookmark',
    'SVP_10', 'SGSEnabled', 'eWORDTYPE_ADDED', 'ISpeechLexiconWord',
    'DISPID_SRGetFormat', 'SP_VISEME_11',
    'DISPID_SOTMatchesAttributes', 'SVP_8',
    'DISPID_SGRSAddWordTransition', 'SpAudioFormat',
    'SSSPTRelativeToEnd', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SpeechFileStream', 'DISPID_SGRInitialState',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRRGetXMLResult',
    'SPXMLRESULTOPTIONS', 'ISpeechPhraseElements', 'SVSFIsXML',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SWFESamplesPerSec',
    'SpeechVoicePriority', 'STSF_AppData', 'SPLEXICONTYPE',
    'ISpeechPhraseReplacement', 'DISPID_SRCCreateGrammar',
    ...
    'ISpeechLexiconPronunciations', 'SSSPTRelativeToStart', 'SVP_12',
    'DISPID_SRRTOffsetFromStart', 'SpMMAudioOut',
    'SpSharedRecognizer', 'DISPID_SLAddPronunciation',
    'SPEI_SR_PRIVATE', 'DISPID_SMSSetData', 'DISPID_SRCRetainedAudio',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRStatus', 'DISPID_SRCVoice',
    ...
    'SpeechCategoryVoices', 'SRCS_Disabled', 'ISpEventSource',
    'SPWORDPRONUNCIATION', 'SRTStandard', 'DISPID_SPPName',
    'SRAInterpreter', 'SAFTADPCM_22kHzStereo', 'SBONone', 'SINone',
    'SpNullPhoneConverter', 'SPTEXTSELECTIONINFO',
    'SRERecoOtherContext', 'SVPAlert', 'SPPS_Noun',
    'DISPID_SABIEventBias', 'STCLocalServer',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SASCurrentSeekPosition', 'SpeechAudioFormatGUIDText',
    'SAFTADPCM_44kHzMono', 'ISpNotifySource', 'eLEXTYPE_PRIVATE14',
    'SRSActive', 'SPSHORTCUTPAIRLIST', 'SPPHRASERULE',
    'DISPID_SDKSetStringValue', 'DISPID_SLGenerationId',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPPNumberOfElements',
    'SRSActiveAlways', 'SpeechAudioFormatType', 'SVPOver',
    ...
    'SPINTERFERENCE_TOOLOUD', 'SpVoice', 'SPAUDIOSTATUS',
    'SVSFNLPMask', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPRuleFirstElement', 'DISPID_SRGDictationUnload',
    'DISPID_SDKEnumValues', 'STSF_FlagCreate', 'SPSInterjection',
    'SPSEMANTICERRORINFO', 'DISPID_SRRecognizer',
    'DISPID_SPERetainedStreamOffset', 'SPAR_High',
    'DISPID_SCSBaseStream', 'DISPID_SVEEnginePrivate',
    'DISPID_SGRClear', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPEAudioStreamOffset', 'SP_VISEME_21',
    'DISPID_SABIBufferSize', 'DISPID_SPCIdToPhone',
    'SPWAVEFORMATTYPE', 'ISpeechPhraseAlternates', 'SVSFlagsAsync',
    'SSTTDictation', 'eLEXTYPE_PRIVATE4', 'IEnumString',
    'DISPID_SRGetRecognizers', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPPS_Modifier', 'DISPID_SPEsCount', 'DISPID_SOTDataKey',
    'DISPID_SGRId', 'SpeechEngineProperties', 'SpStream',
    'SPSERIALIZEDRESULT', 'SAFTCCITT_uLaw_44kHzStereo',
    'SGRSTTTextBuffer', 'DISPID_SVResume', 'SPBINARYGRAMMAR',
    'IStream', 'DISPID_SPPValue', 'SPEI_RESERVED3', 'DISPID_SPEsItem',
    'DISPID_SpeechLexiconWord', 'SPSNotOverriden', 'SVP_13',
    'SECFIgnoreCase', 'DISPID_SGRSTransitions',
    'DISPID_SRCRecognizer', 'DISPID_SVSLastBookmark',
    'SDKLLocalMachine', 'SSFMCreateForWrite', 'SPCT_COMMAND',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPIAudioSizeBytes',
    'DISPIDSPTSI_SelectionLength', 'ISpRecognizer3', 'SITooQuiet',
    'ISpeechObjectTokens', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVWaitUntilDone', 'SPDKL_LocalMachine', 'SPAS_PAUSE',
    'IInternetSecurityManager', 'SPEI_ADAPTATION',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTCEnumerateTokens',
    'SPEVENTENUM', 'SPRS_INACTIVE', 'DISPID_SDKGetStringValue',
    'SVSFVoiceMask', 'SPRULESTATE', 'DISPID_SPISaveToMemory',
    'SAFT32kHz16BitStereo', 'SDTAlternates', 'SGDSActive',
    'SPVISEMES', 'ISequentialStream', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRSTRule', 'SpPhraseInfoBuilder',
    ...
    'DISPID_SOTCSetId', 'DISPID_SRRSetTextFeedback', 'SPXRO_SML',
    'DISPIDSPTSI_ActiveOffset', 'SpeechRecognitionType',
    'DISPID_SLPsItem', 'ISpeechPhraseReplacements',
    'DISPID_SVSInputWordLength', 'SPRST_INACTIVE',
    'SSFMOpenReadWrite', 'ISpNotifyTranslator',
    'DISPID_SPPConfidence', 'SpResourceManager', 'DISPID_SPACommit',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVAudioOutputStream',
    'SWPKnownWordPronounceable', 'SVP_16', 'SpMMAudioEnum',
    'DISPID_SRCESoundEnd', 'DISPID_SRCBookmark', 'SPRULE',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechObjectTokenCategory',
    'SPEI_SENTENCE_BOUNDARY', 'SDTReplacement', 'SREPrivate',
    'DISPID_SRSNumberOfActiveRules', 'SAFTADPCM_11kHzStereo',
    'eLEXTYPE_VENDORLEXICON', 'SAFTGSM610_44kHzMono',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRCERecognizerStateChange',
    'SP_VISEME_1', 'STCAll', 'ISpRecognizer2',
    'DISPID_SpeechPhraseRule', 'ISpeechPhraseInfoBuilder',
    'ISpeechAudio', 'ISpXMLRecoResult', 'eLEXTYPE_RESERVED10',
    'SpeechAllElements', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPSERIALIZEDPHRASE', 'SpWaveFormatEx', 'DISPID_SPCLangId',
    'SVEPrivate', 'SLOStatic', 'DISPID_SVSLastResult',
    'SPRECORESULTTIMES', 'DISPID_SVSpeakStream',
    'DISPID_SpeechPhoneConverter', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_PRIVATE1', 'SVEWordBoundary', 'SREStreamStart',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SDKDeleteKey',
    'DISPID_SVAudioOutput', 'SVEAudioLevel', 'SPSHT_EMAIL',
    'SREStateChange', 'ISpEventSink', 'SPLO_DYNAMIC', 'SASClosed',
    'SAFTCCITT_ALaw_11kHzStereo', 'SRAImport', 'SGRSTTRule',
    'SVF_Stressed', 'SPEI_PROPERTY_STRING_CHANGE', 'SpeechVisemeType',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpSerializeState',
    'DISPID_SASetState', 'DISPID_SpeechPhraseRules',
    'DISPID_SVEVoiceChange', 'SPRST_ACTIVE_ALWAYS',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRSTPropertyName',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSInputWordPosition',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRName',
    'DISPID_SVSInputSentencePosition', 'Speech_Default_Weight',
    'DISPID_SRGRecoContext', 'DISPID_SRCPause', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRRAlternates', 'SpeechGrammarTagDictation',
    'DISPID_SRCEEndStream', 'SPPS_RESERVED4', 'DISPID_SGRsCommit',
    'SVP_14', 'eLEXTYPE_PRIVATE20', 'ISpObjectToken',
    'ISpeechXMLRecoResult', 'SPFM_OPEN_READONLY',
    'SAFT48kHz16BitMono', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_USER_SHORTCUT', 'SPEI_WORD_BOUNDARY', 'SDTDisplayText',
    'ISpeechRecognizerStatus', 'DISPID_SOTCGetDataKey',
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitMono',
    'DISPID_SPIStartTime', 'DISPID_SLWType',
    'DISPID_SASNonBlockingIO', 'SRTReSent', 'ISpResourceManager',
    'SPINTERFERENCE_NOSIGNAL', 'ISpStream', 'IEnumSpObjectTokens',
    'ISpPhoneConverter', 'DISPID_SVGetProfiles',
    'DISPID_SPRuleConfidence', 'SPAS_STOP', 'SpeechCategoryAudioOut',
    'DISPID_SGRAddResource', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRSAudioStatus',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_START_INPUT_STREAM',
    'DISPID_SFSOpen', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SLWs_NewEnum', 'SPPS_Unknown', 'DISPID_SVAlertBoundary',
    'SDKLDefaultLocation', 'SFTInput',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechAudioVolume',
    'eLEXTYPE_RESERVED6', 'SVP_20', 'SpObjectToken',
    'SPCT_SUB_DICTATION', 'DISPID_SRGDictationLoad',
    'SREPropertyNumChange', 'DISPID_SVSkip', 'SRADefaultToActive',
    'DISPID_SOTCDefault', 'DISPID_SASFreeBufferSpace', 'SPAS_CLOSED',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechStreamSeekPositionType', 'SVP_18', 'SPEI_VISEME',
    'DISPID_SpeechAudio', 'SpeechWordType', 'DISPID_SOTCategory',
    'SPEI_INTERFERENCE', 'SP_VISEME_13',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVSpeak',
    'SAFT22kHz16BitStereo', 'SPRST_ACTIVE',
    'DISPID_SpeechLexiconPronunciation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpDataKey',
    'eLEXTYPE_MORPHOLOGY', 'UINT_PTR', 'SRSEDone', 'SWTAdded',
    'SDA_No_Trailing_Space', 'SAFTExtendedAudioFormat',
    'DISPID_SPELexicalForm', 'SECFIgnoreKanaType',
    'DISPID_SVEventInterests', 'DISPID_SLPPartOfSpeech',
    'SGLexicalNoSpecialChars', 'SRTAutopause', 'ISpeechRecoGrammar',
    'SFTSREngine', 'ISpObjectWithToken', 'SpeechCategoryAudioIn',
    'SPAO_RETAIN_AUDIO', 'DISPID_SAFGuid', 'IInternetSecurityMgrSite',
    'SRARoot', 'SPGS_EXCLUSIVE', 'DISPID_SPRDisplayAttributes',
    'SVP_4', 'ISpeechLexicon', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPPId', 'SAFT32kHz8BitMono', 'DISPID_SOTCId',
    'DISPID_SABufferInfo', 'SpTextSelectionInformation',
    'ISpeechRecoResultTimes', 'SP_VISEME_19', 'SPXRO_Alternates_SML',
    'ISpRecoResult', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechGrammarRules', 'DISPID_SRRTimes',
    'DISPID_SRCEPhraseStart', 'SpeechLoadOption', 'SAFT48kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVSFIsNotXML',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRSTsItem',
    'DISPID_SRCERecognitionForOtherContext', 'SPWORDTYPE',
    'SpeechVisemeFeature', 'SpeechTokenShellFolder',
    'DISPID_SpeechRecognizer', 'SVP_17', 'SRCS_Enabled',
    'DISPID_SPRsCount', 'SAFT22kHz16BitMono', 'ISpRecognizer',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRRTLength',
    'SRSInactiveWithPurge', 'SP_VISEME_14', 'DISPID_SVEViseme',
    'SAFT32kHz8BitStereo', 'DISPID_SRIsShared',
    'DISPID_SPRuleChildren', '_RemotableHandle',
    'SpeechCategoryRecognizers', 'DISPID_SpeechRecoResultTimes',
    'ISpeechAudioFormat', 'DISPID_SMSALineId', 'ISpeechCustomStream',
    'SGRSTTWord', 'DISPID_SpeechPhraseElements', 'SPEI_SR_BOOKMARK',
    'ISpGrammarBuilder', 'SPEI_UNDEFINED', 'SPPROPERTYINFO',
    'SVSFUnusedFlags', 'DISPID_SVEStreamEnd', 'SVP_21',
    'DISPID_SPAs_NewEnum', 'SPCATEGORYTYPE', 'DISPID_SVSVisemeId',
    'SPVPRI_OVER', 'SPFM_CREATE', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRRAudioFormat', 'SPSUnknown', 'SPVPRIORITY',
    'DISPID_SRSetPropertyString', 'SASRun', 'DISPID_SRState',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPPS_NotOverriden',
    'DISPID_SpeechLexiconProns', 'SGPronounciation', 'WAVEFORMATEX',
    'ISpeechRecognizer', 'DISPID_SPRuleId', 'SpeechRecoContextState',
    'DISPID_SGRsCount', 'DISPID_SVEWord', 'DISPID_SLWPronunciations',
    'SP_VISEME_9', 'SpeechRetainedAudioOptions',
    'DISPID_SGRsCommitAndSave', 'SPEI_SOUND_END', 'SPCT_SLEEP',
    'SPPHRASEELEMENT', 'SITooLoud', 'SVP_11', 'DISPID_SPARecoResult',
    'SDKLCurrentUser', 'SPEI_END_SR_STREAM', 'DISPID_SGRAttributes',
    'SVSFParseSsml', 'SAFT16kHz8BitStereo', 'DISPID_SPRuleParent',
    'SRTEmulated', 'SPEI_MAX_TTS', 'SGDSActiveWithAutoPause',
    'DISPID_SVSyncronousSpeakTimeout', 'SREAllEvents',
    'DISPID_SVESentenceBoundary', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechPhraseRules',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseProperty', 'SVP_6', 'SPGRAMMARWORDTYPE',
    'DISPID_SRSSupportedLanguages', 'DISPID_SDKEnumKeys',
    'SLODynamic', 'SpCompressedLexicon', 'DISPID_SpeechAudioFormat',
    'SAFT22kHz8BitStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_MIN_SR', 'LONG_PTR', 'tagSPPROPERTYINFO',
    'SAFTADPCM_22kHzMono', 'ISpeechPhraseProperty',
    'DISPID_SBSFormat', 'SpeechStreamFileMode', 'SpSharedRecoContext',
    'eLEXTYPE_PRIVATE16', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SpeechRecoResult2', 'SpeechMicTraining', 'SPEI_MIN_TTS',
    'SPGRAMMARSTATE', 'SVEViseme', 'DISPID_SRCERecognition',
    'SpeechVoiceEvents', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPCPhoneToId', 'SVEBookmark', 'SVSFPersistXML',
    'SPSEMANTICFORMAT', 'SpeechRuleState',
    'DISPID_SGRSAddSpecialTransition', 'SPINTERFERENCE_NOISE',
    'SP_VISEME_12', 'DISPID_SpeechGrammarRule', 'DISPID_SWFEChannels',
    'DISPID_SVVolume', 'SDTProperty', 'DISPID_SGRSTPropertyId',
    'SPEI_RESERVED2', 'ISpeechAudioStatus', 'SVSFPurgeBeforeSpeak',
    'SAFT8kHz16BitStereo', 'SRADynamic', 'SECLowConfidence',
    'DISPID_SpeechVoiceEvent', 'SVP_3', 'SpInprocRecognizer',
    'SpeechDiscardType', 'SPEI_RESERVED5', 'DISPID_SRCEEnginePrivate',
    'DISPID_SpeechPhraseReplacement', 'SPWT_LEXICAL',
    'DISPID_SVSPhonemeId', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRCEAudioLevel', 'SAFTCCITT_uLaw_22kHzMono',
    'SPDKL_DefaultLocation', 'DISPID_SRGIsPronounceable',
    'SPEI_RESERVED6', 'SpeechUserTraining', 'SP_VISEME_15',
    'SpeechVoiceCategoryTTSRate', 'SPAR_Low', 'SASStop', 'SVP_7',
    'SpShortcut', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_PRIVATE2', 'SPPS_RESERVED2',
    'DISPID_SpeechXMLRecoResult', 'SVESentenceBoundary',
    'ISpeechMMSysAudio', 'SPEI_HYPOTHESIS', 'SGDSActiveUserDelimited',
    'DISPID_SPRules_NewEnum', 'SpeechPropertyComplexResponseSpeed',
    'SPEI_RECOGNITION', 'DISPID_SVEAudioLevel', 'SPCONTEXTSTATE',
    'SSFMCreate', 'DISPID_SAFSetWaveFormatEx', 'DISPID_SRRPhraseInfo',
    'SPEI_TTS_PRIVATE', 'SpObjectTokenCategory',
    'ISpeechGrammarRuleState', 'STSF_LocalAppData',
    'SPRECOGNIZERSTATUS', 'SREPhraseStart', 'SPPS_Function',
    'SAFTNonStandardFormat', '_SPAUDIOSTATE',
    'DISPID_SPIGetDisplayAttributes', 'SPPHRASEREPLACEMENT',
    'ISpeechPhraseRule', 'DISPID_SABufferNotifySize',
    'DISPID_SASState', 'DISPID_SRCreateRecoContext',
    'DISPID_SRRSpeakAudio', 'SpeechRunState', 'SPAR_Medium',
    'SPCS_DISABLED', 'ISpeechRecoContext', 'DISPID_SPRFirstElement',
    'ISpLexicon', 'SINoise', 'SPRST_NUM_STATES', 'SPFILEMODE',
    'DISPID_SpeechRecoContext', 'DISPID_SDKSetLongValue', 'SLTApp',
    'SAFTCCITT_uLaw_44kHzMono', 'SPAR_Unknown', 'eLEXTYPE_APP',
    'DISPID_SpeechWaveFormatEx', 'SPCT_SUB_COMMAND', 'SPWORDLIST',
    'SpeechLexiconType', 'DISPID_SRGState',
    'DISPID_SPEActualConfidence', 'SAFT32kHz16BitMono',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_PRIVATE10',
    'SVEStartInputStream', 'DISPID_SGRSTWeight', 'SPGS_DISABLED',
    'SDKLCurrentConfig', 'SPRST_INACTIVE_WITH_PURGE',
    'SPCT_DICTATION', 'SpeechPropertyResourceUsage',
    'SECHighConfidence', 'SRESoundStart',
    'DISPID_SRGCmdLoadFromMemory', 'SPDKL_CurrentUser',
    'DISPID_SMSAMMHandle', 'DISPID_SBSSeek', 'SPSLMA',
    'SGRSTTEpsilon', 'SAFT12kHz16BitMono', 'SAFT48kHz8BitStereo',
    'ISpObjectTokenCategory', 'ISpeechWaveFormatEx', 'SPLOADOPTIONS',
    'DISPID_SpeechPhraseProperties',
    'ISpeechTextSelectionInformation', 'SpeechDictationTopicSpelling',
    'SpeechTokenKeyFiles', 'DISPID_SRGCmdSetRuleState',
    'ISpeechAudioBufferInfo', 'SPSHORTCUTPAIR', 'SpeechAddRemoveWord',
    'SDA_One_Trailing_Space', 'SREBookmark', 'SAFT16kHz16BitMono',
    'DISPID_SPIRule', 'DISPID_SRGSetTextSelection', 'SPPHRASE',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SREmulateRecognition',
    'SpeechBookmarkOptions', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPPsItem',
    'ISpeechPhraseAlternate', 'SWPUnknownWordUnpronounceable',
    'DISPID_SLWsCount', 'SPINTERFERENCE',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SOTsItem',
    'DISPID_SPEs_NewEnum', 'DISPID_SRGCmdLoadFromObject',
    'ISpRecoContext', 'SAFT11kHz8BitStereo', 'SpMMAudioIn',
    'DISPID_SVEBookmark', 'DISPID_SLPSymbolic', 'DISPID_SPRuleName',
    'eLEXTYPE_PRIVATE8', 'DISPID_SLPPhoneIds', 'ISpStreamFormat',
    'DISPID_SGRSTText', 'DISPID_SVGetVoices', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE15',
    'SPWF_INPUT', 'DISPID_SVGetAudioOutputs', 'SRATopLevel',
    'SREAudioLevel', 'DISPID_SRCSetAdaptationData',
    'SAFT16kHz16BitStereo', 'DISPID_SRCESoundStart',
    'DISPID_SOTCreateInstance', 'DISPID_SAVolume', 'DISPID_SGRsItem',
    'eWORDTYPE_DELETED', 'DISPID_SPRuleNumberOfElements',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPPs_NewEnum', 'DISPID_SRCState',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCEInterference',
    'SAFT48kHz16BitStereo', 'SP_VISEME_5', 'SpeechGrammarState',
    'DISPID_SRProfile', 'SpeechPropertyHighConfidenceThreshold',
    'SDA_Consume_Leading_Spaces', 'DISPID_SGRSTsCount',
    'DISPID_SPPEngineConfidence', 'SP_VISEME_20',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPERequiredConfidence',
    'ISpeechRecoResult', 'ISpeechBaseStream',
    'ISpeechRecoResultDispatch', 'DISPID_SPIGetText',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPRText', 'SPSSuppressWord',
    'SpeechAudioState', 'SRAONone', 'SpeechTokenKeyAttributes',
    'SAFT24kHz8BitStereo', 'SPAUDIOSTATE', 'SVP_5',
    'DISPID_SRGetPropertyNumber', 'SAFTADPCM_11kHzMono',
    'SpeechRecoProfileProperties', 'SAFTNoAssignedFormat',
    'SP_VISEME_7', 'DISPID_SPAPhraseInfo', 'DISPID_SRCERequestUI',
    ...
    'Speech_Max_Pron_Length', 'DISPID_SPPFirstElement',
    'DISPID_SpeechCustomStream', 'SPBO_AHEAD', 'SpPhoneConverter',
